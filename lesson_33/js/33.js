...
let marker2 = L.marker(gckCoordinates).addTo(currentMap); //Geographic Center of Kiev
let marker3 = L.marker(miCoordinates).addTo(currentMap); //Monument of Independence
